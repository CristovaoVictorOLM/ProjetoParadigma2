 ...
 */
public class ServletGerenciarItem_Tema extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
              ...
              //  List<Funcionario> lista = new ArrayList<Funcionario>();
                Item_Tema ses = new Item_Tema();
                 // func.setIdfunc(codigofunc);
                  ses.setiditem(codigofunc);
                  ses.setnmItem(nomefunc);

                  int comando = myFacade.inserirItem_Tema(ses);
