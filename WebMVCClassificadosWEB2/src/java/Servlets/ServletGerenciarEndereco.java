 ...
 */
public class ServletGerenciarEndereco extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int codigofunc = Integer.parseInt(request.getParameter("idendereco"));
        String nometipoanuncio = request.getParameter("cep");
        String qtdpalavras = request.getParameter("bairro");
        ...
        try {
              ...
              //  List<Funcionario> lista = new ArrayList<Funcionario>();
                Endereco func = new Endereco();
                  func.setIdEndereco(codigofunc);//Idfunc(codigofunc);
                  func.setcep(nometipoanuncio);
                  func.setbairro(qtdpalavras);//Fone(fonefunc);
                  func.setlogradouro(logra);


               int comando = myFacade.inserirEndereco(func);
