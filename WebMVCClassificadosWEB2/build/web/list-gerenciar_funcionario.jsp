...
<%
	Item_Tema[] vbItemtema = (Item_Tema[]) request.getSession().getAttribute("listagemgeral");
%>
...
<div id="content">
        ...
        <table border="0">
          ...
          <tr> 
            <td colspan="4">    <% if (vbItemtema != null) {
	                            for (int i=0; i < vbItemtema.length; i++) { %></td>
          </tr>
          <tr> 
            <td><%=vbItemtema[i].getiditem()%></td>
            <td><%=vbItemtema[i].getnmItem()%></td>
