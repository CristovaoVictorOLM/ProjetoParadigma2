...
<%
	Tema[] vbSessao = (Tema[]) request.getSession().getAttribute("listagemgeral");
%>
...
<div id="content">
        ...
        <table border="0">
          <tr bgcolor="#666666"> 
            <td width="157"><strong><font color="#FFFFFF">Id do Tema</font></strong></td>
            <td width="530"><strong><font color="#FFFFFF">Nome do Tema</font></strong></td>
          ...
          <tr> 
            <td><%=vbSessao[i].getidTema()%></td>
            <td><%=vbSessao[i].getnmTema()%></td>
            <td>&nbsp;</td>
